package org.ohosdev.hapviewerweb.util;
            ...
            if (targetAbility != null) {
                if (targetAbility.containsKey("icon")) {
                    ...
                    try {
                        ...
                        hapInfo.iconBase64 = "data:image/png;base64," + Base64.encode(hapInfo.iconBytes);
                    } catch (Exception ignore) {}
                } else {
                    hapInfo.iconBase64 = "/assets/img/icon-default_new.png";
                }
                // 同时记录下label，用于下面解析名称
